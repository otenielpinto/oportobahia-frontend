    ...
    .aggregate([
      ...
      //second stage
      {
        $group: {
          ...
          nfe_numero: { $first: "$itens.nfe_numero" },
          codigo: { $first: "$itens.codigo" },
          nome_vendedor: { $first: "$itens.nome_vendedor" },
          data_movto: { $first: "$itens.data_movto" },
          data_emissao: { $first: "$itens.data_emissao" },
          ...
          nfe_cfop: { $first: "$itens.nfe_cfop" },
          unidade: { $first: "$itens.unidade" },
          nome_ecommerce: { $first: "$itens.nome_ecommerce" },
